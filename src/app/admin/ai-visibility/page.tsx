          ...
          <div className="flex flex-wrap gap-1.5">
            {STARTER_QUERIES.map((q) => (
              <button
                ...
                className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs text-slate-600 transition hover:border-primary hover:text-primary dark:border-slate-800 dark:bg-slate-800/50 dark:text-slate-300 dark:hover:border-primary dark:hover:text-primary"
              >
                {q}
              </button>
            ))}
