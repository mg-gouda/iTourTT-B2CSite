...
const translations: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    "booking.aiIntro": "Hi! Tell me your trip in your own words — e.g. 'Hurghada airport to Steigenberger Al Dau tomorrow 3pm, 4 people' — and I'll find your transfer.",
  ...
  ar: {
    ...
    "booking.aiIntro": "مرحبًا! صف رحلتك بكلماتك — مثال: «من مطار الغردقة إلى شتايجنبرجر الدو غدًا الساعة 3 مساءً، 4 أشخاص» — وسأجد لك الانتقال المناسب.",
  ...
  de: {
    ...
    "booking.aiIntro": "Hallo! Beschreiben Sie Ihre Fahrt in eigenen Worten — z. B. „Flughafen Hurghada zum Steigenberger Al Dau morgen 15 Uhr, 4 Personen“ — und ich finde Ihren Transfer.",
  ...
  fr: {
    ...
    "booking.aiIntro": "Bonjour ! Décrivez votre trajet avec vos mots — par ex. « Aéroport d'Hurghada vers Steigenberger Al Dau demain 15h, 4 personnes » — et je trouverai votre transfert.",
  ...
  it: {
    ...
    "booking.aiIntro": "Ciao! Descrivi il tuo viaggio con parole tue — es. « Aeroporto di Hurghada allo Steigenberger Al Dau domani alle 15, 4 persone » — e troverò il tuo transfer.",
  ...
  nl: {
    ...
    "booking.aiIntro": "Hoi! Beschrijf je rit in je eigen woorden — bijv. 'Luchthaven Hurghada naar Steigenberger Al Dau morgen 15:00 uur, 4 personen' — en ik vind je transfer.",
  ...
  ru: {
    ...
    "booking.aiIntro": "Здравствуйте! Опишите поездку своими словами — например: «Из аэропорта Хургады в Steigenberger Al Dau завтра в 15:00, 4 человека» — и я подберу трансфер.",
