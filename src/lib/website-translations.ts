// ─── Shared translation data (non-client) ────────────────────────
// Holds the website i18n dictionary and a hook-free `translate()` so it
// can be used from BOTH client components (via useWT in website-i18n.tsx)
// and Server Components (which cannot call functions exported from a
// "use client" module). Keep this file free of React/client-only imports.

import type { Locale } from './website-i18n';
...
const translations: Record<Locale, Record<string, string>> = {
  ...
  en: {
    // ── Booking funnel ──
    "funnel.step.vehicle": "Select Vehicle",
    "funnel.step.flight": "Flight & Extras",
    "funnel.step.details": "Your Details",
    "funnel.editSearch": "Edit Search",
    "funnel.back": "Back",
    "funnel.label.arrival": "Arrival",
    "funnel.label.departure": "Departure",
    "funnel.label.twoWay": "2-Way",
    "funnel.label.cityToCity": "City-to-City",
    "funnel.transferSuffix": "Transfer",
    "funnel.paxCount": "{n} passengers",
    "funnel.chooseVehicle": "Choose your vehicle",
    "funnel.pricesPerVehicle": "All prices are per vehicle, not per person.",
    "funnel.errNoResults": "No results found for this route.",
    "funnel.errLoad": "Failed to load vehicles.",
    "funnel.goBackTry": "Go back and try again",
    "funnel.noVehicles": "No vehicles available for this route.",
    "funnel.tryDifferent": "Try a different date or passenger count.",
    "funnel.upTo": "up to {n}",
    "funnel.ac": "A/C",
    "funnel.wifi": "Wi-Fi",
    "funnel.gps": "GPS",
    "funnel.manual": "manual",
    "funnel.automatic": "automatic",
    "funnel.copy": "Copy",
    "funnel.copied": "Copied!",
    "funnel.copyReference": "Copy reference",
    "funnel.tipAc": "Air conditioning",
    "funnel.tipWifi": "Wi-Fi on board",
    "funnel.tipGps": "GPS Tracked",
    "funnel.tipTransmission": "Transmission",
    "funnel.tipLuggage": "Luggage capacity",
    "funnel.tipSeats": "Passenger capacity",
    "funnel.roundTripIncl": "Round trip · both legs included",
    "funnel.perVehicleIncl": "Per vehicle · all inclusive",
    "funnel.bookNow": "Book now",
    "funnel.flightDetails": "Flight details",
    "funnel.flightSubArr": "Your arrival flight information so we can monitor delays.",
    "funnel.flightSubDep": "Your departure flight information for scheduling.",
    "funnel.flightInformation": "Flight Information",
    "funnel.flightNumber": "Flight Number",
    "funnel.terminal": "Terminal",
    "funnel.originFrom": "Origin (flying from)",
    "funnel.destinationTo": "Destination (flying to)",
    "funnel.returnFlight": "Return Flight (departure)",
    "funnel.returnFlightNumber": "Return Flight Number",
    "funnel.yourVehicle": "Your Vehicle",
    "funnel.capacityN": "Capacity: {n} seats",
    "funnel.bags": "{n} bags",
    "funnel.optionalExtras": "Optional Extras",
    "funnel.changeVehicle": "Change vehicle",
    "funnel.noOtherVehicle": "No other vehicle on this route can carry the selected passengers and extras.",
    "funnel.occupiesSeat": "occupies a seat",
    "funnel.onlySuffix": "{names} only",
    "funnel.specialRequests": "Special Requests",
    "funnel.specialRequestsPh": "Any special requirements or notes for the driver…",
    "funnel.yourPrice": "Your price",
    "funnel.inclExtras": "incl. {amount} extras",
    "funnel.paxShort": "{n} pax",
    "funnel.continueDetails": "Continue to Your Details",
    "funnel.alertVehicleType": "\"{extra}\" can only be carried by {names}. Switch your vehicle below to add it — no need to start your search over.",
    "funnel.alertCapacity": "This {seats}-seat vehicle is full with {pax} passengers and the extras already selected. Switch to a larger vehicle below to add \"{extra}\" — no need to start your search over.",
    "funnel.bookingConfirmed": "Booking Confirmed!",
    "funnel.yourReference": "Your reference:",
    "funnel.confirmationSent": "A confirmation has been sent to {email}",
    "funnel.accountCreated": "Account Created for You",
    "funnel.accountDesc": "Log in to manage your booking, track your driver, and amend or cancel your trip.",
    "funnel.emailUsername": "Email (username)",
    "funnel.password": "Password",
    "funnel.passwordNote": "Your password is your mobile number. You can change it after logging in.",
    "funnel.goToAccount": "Go to My Account",
    "funnel.alreadyAccount": "Already have an account? Log in to manage your booking →",
    "funnel.backHome": "Back to Home",
    "funnel.yourDetails": "Your details",
    "funnel.confirmationHere": "We'll send your booking confirmation here.",
    "funnel.personalInfo": "Personal Information",
    "funnel.fullName": "Full Name",
    "funnel.email": "Email",
    "funnel.phone": "Phone",
    "funnel.country": "Country",
    "funnel.bookingSummary": "Booking Summary",
    "funnel.transfer": "Transfer",
    "funnel.total": "Total",
    "funnel.paymentMethod": "Payment Method",
    "funnel.paymentUnavailable": "Online booking is temporarily unavailable. Please contact us to complete your booking.",
    "funnel.onlinePayment": "Online Payment",
    "funnel.onlinePaymentDesc": "Pay securely by card now",
    "funnel.cashArrival": "Pay Cash Upon Arrival",
    "funnel.cashArrivalDesc": "Pay your driver in cash",
    "funnel.proceedPayment": "Proceed to Payment",
    "funnel.confirmBooking": "Confirm Booking",
    "funnel.processing": "Processing…",
    "funnel.termsAgree": "By confirming you agree to our terms of service.",
    "funnel.redirectNote": "You'll be redirected to our secure payment provider.",
    "funnel.payOnArrivalNote": "Payment is collected on arrival.",
    "funnel.onlinePaymentRefNote": "You'll get a booking reference to add to your payment notes for tracking.",
    "funnel.paymentRefTitle": "Almost done — note your reference",
    "funnel.paymentRefInstruction": "Your booking is reserved. Please add the booking reference below to your payment notes / description so we can match your payment to this booking.",
    "funnel.paymentRefNote": "Add this reference in the payment notes on the next screen.",
    "funnel.cancellationPolicy": "Cancellation Policy",
    "funnel.cancellationPolicyLabel": "Cancellation policy:",
    "funnel.cancellationPolicyText": "Free cancellation up to 48 hours before your scheduled pickup. Cancellations within 48 hours of departure cannot be processed.",
    "funnel.policiesTitle": "Cancellation & No-Show Policies",
    "funnel.noShowPolicy": "No-Show Policy",
    "funnel.noShowPolicyText": "If you are not at the agreed pickup point at the scheduled time and our team cannot reach you, the booking is treated as a no-show and is non-refundable.",
    "funnel.selectedRoute": "Your Selected Route",
    "funnel.routeFrom": "From",
    "funnel.routeTo": "To",
    "funnel.routeWhen": "Pickup",
    "funnel.routeReturn": "Return",
    "funnel.routePassengers": "Passengers",
    // Navigation
    "nav.home": "Home",
    ...
    "booking.outboundTrip": "Outbound Trip",
    "booking.returnTrip": "Return Trip",
    "booking.pickup": "Pickup",
    "booking.dropoff": "Drop-off",
    "booking.twoWayTransfer": "2-Way Transfer",
    "booking.cityToCity": "City to City",
    "booking.aiMode": "AI Mode",
    "booking.aiIntro": "Hi, I'm the Transfera AI Assistant 👋 I'll help you book your transfer step by step — all the way to the personal details page. Just tell me your trip in your own words, e.g. 'Hurghada airport to Steigenberger Al Dau tomorrow 3pm, 4 people'.",
    "booking.aiPlaceholder": "Describe your transfer…",
    "booking.aiSend": "Send",
    "booking.aiThinking": "Thinking…",
    "booking.aiError": "Sorry, something went wrong. Please try again or use the standard search.",
    "booking.aiDisclaimer": "Assists with Transfera transfer bookings only.",
    "booking.aiTitle": "Transfera AI Assistant",
    "booking.aiSubtitle": "Books your transfer up to the personal details page",
    "booking.aiMic": "Speak",
    "booking.aiListening": "Listening…",
    "booking.aiVoiceOn": "Voice replies on",
    "booking.aiVoiceOff": "Voice replies off",
    ...
    "track.emailPlaceholder": "Email used to book",
    "track.emailHint": "Enter your booking reference and the email address you used when booking.",
    "track.search": "Track",
    ...
    "blog.heading": "The Transfera Blog",
    "blog.subheading": "Travel tips, destination guides and everything you need for a smooth airport transfer in Egypt.",
    "blog.read": "Read",
    "blog.empty": "No articles published yet. Check back soon.",
    "blog.backToBlog": "Back to blog",
    "destinations.heading": "Egypt Airport Transfer Destinations",
    "destinations.subheading": "Private transfers to and from every major Egyptian airport. Fixed price, flight tracking, free cancellation.",
    "destinations.empty": "Destinations coming soon.",
  ...
  ar: {
    // ── Booking funnel ──
    "funnel.step.vehicle": "اختر المركبة",
    "funnel.step.flight": "الرحلة والإضافات",
    "funnel.step.details": "بياناتك",
    "funnel.editSearch": "تعديل البحث",
    "funnel.back": "رجوع",
    "funnel.label.arrival": "وصول",
    "funnel.label.departure": "مغادرة",
    "funnel.label.twoWay": "ذهاب وعودة",
    "funnel.label.cityToCity": "من مدينة إلى مدينة",
    "funnel.transferSuffix": "نقل",
    "funnel.paxCount": "{n} ركاب",
    "funnel.chooseVehicle": "اختر مركبتك",
    "funnel.pricesPerVehicle": "جميع الأسعار لكل مركبة، وليست لكل شخص.",
    "funnel.errNoResults": "لا توجد نتائج لهذا المسار.",
    "funnel.errLoad": "تعذّر تحميل المركبات.",
    "funnel.goBackTry": "ارجع وحاول مرة أخرى",
    "funnel.noVehicles": "لا توجد مركبات متاحة لهذا المسار.",
    "funnel.tryDifferent": "جرّب تاريخاً مختلفاً أو عدد ركاب مختلف.",
    "funnel.upTo": "حتى {n}",
    "funnel.ac": "تكييف",
    "funnel.wifi": "واي فاي",
    "funnel.gps": "GPS",
    "funnel.manual": "يدوي",
    "funnel.automatic": "أوتوماتيك",
    "funnel.copy": "نسخ",
    "funnel.copied": "تم النسخ!",
    "funnel.copyReference": "نسخ الرقم المرجعي",
    "funnel.tipAc": "تكييف هواء",
    "funnel.tipWifi": "واي فاي داخل السيارة",
    "funnel.tipGps": "تتبع GPS",
    "funnel.tipTransmission": "ناقل الحركة",
    "funnel.tipLuggage": "سعة الأمتعة",
    "funnel.tipSeats": "سعة الركاب",
    "funnel.roundTripIncl": "ذهاب وعودة · يشمل الرحلتين",
    "funnel.perVehicleIncl": "لكل مركبة · شامل كل شيء",
    "funnel.bookNow": "احجز الآن",
    "funnel.flightDetails": "تفاصيل الرحلة",
    "funnel.flightSubArr": "معلومات رحلة وصولك حتى نتمكن من متابعة التأخيرات.",
    "funnel.flightSubDep": "معلومات رحلة مغادرتك لتنظيم الموعد.",
    "funnel.flightInformation": "معلومات الرحلة",
    "funnel.flightNumber": "رقم الرحلة",
    "funnel.terminal": "المبنى",
    "funnel.originFrom": "المغادرة من (قادم من)",
    "funnel.destinationTo": "الوجهة (متّجه إلى)",
    "funnel.returnFlight": "رحلة العودة (المغادرة)",
    "funnel.returnFlightNumber": "رقم رحلة العودة",
    "funnel.yourVehicle": "مركبتك",
    "funnel.capacityN": "السعة: {n} مقاعد",
    "funnel.bags": "{n} حقائب",
    "funnel.optionalExtras": "إضافات اختيارية",
    "funnel.changeVehicle": "تغيير المركبة",
    "funnel.noOtherVehicle": "لا توجد مركبة أخرى على هذا المسار يمكنها استيعاب الركاب والإضافات المحددة.",
    "funnel.occupiesSeat": "يشغل مقعداً",
    "funnel.onlySuffix": "{names} فقط",
    "funnel.specialRequests": "طلبات خاصة",
    "funnel.specialRequestsPh": "أي متطلبات خاصة أو ملاحظات للسائق…",
    "funnel.yourPrice": "سعرك",
    "funnel.inclExtras": "يشمل {amount} للإضافات",
    "funnel.paxShort": "{n} راكب",
    "funnel.continueDetails": "المتابعة إلى بياناتك",
    "funnel.alertVehicleType": "«{extra}» يمكن نقله فقط بواسطة {names}. غيّر مركبتك أدناه لإضافته — دون الحاجة لإعادة البحث من جديد.",
    "funnel.alertCapacity": "هذه المركبة ذات {seats} مقاعد ممتلئة بـ {pax} ركاب والإضافات المختارة بالفعل. انتقل إلى مركبة أكبر أدناه لإضافة «{extra}» — دون الحاجة لإعادة البحث من جديد.",
    "funnel.bookingConfirmed": "تم تأكيد الحجز!",
    "funnel.yourReference": "رقمك المرجعي:",
    "funnel.confirmationSent": "تم إرسال تأكيد إلى {email}",
    "funnel.accountCreated": "تم إنشاء حساب لك",
    "funnel.accountDesc": "سجّل الدخول لإدارة حجزك وتتبّع سائقك وتعديل رحلتك أو إلغائها.",
    "funnel.emailUsername": "البريد الإلكتروني (اسم المستخدم)",
    "funnel.password": "كلمة المرور",
    "funnel.passwordNote": "كلمة مرورك هي رقم هاتفك المحمول. يمكنك تغييرها بعد تسجيل الدخول.",
    "funnel.goToAccount": "اذهب إلى حسابي",
    "funnel.alreadyAccount": "لديك حساب بالفعل؟ سجّل الدخول لإدارة حجزك ←",
    "funnel.backHome": "العودة إلى الرئيسية",
    "funnel.yourDetails": "بياناتك",
    "funnel.confirmationHere": "سنرسل تأكيد حجزك إلى هنا.",
    "funnel.personalInfo": "المعلومات الشخصية",
    "funnel.fullName": "الاسم الكامل",
    "funnel.email": "البريد الإلكتروني",
    "funnel.phone": "الهاتف",
    "funnel.country": "الدولة",
    "funnel.bookingSummary": "ملخص الحجز",
    "funnel.transfer": "النقل",
    "funnel.total": "الإجمالي",
    "funnel.paymentMethod": "طريقة الدفع",
    "funnel.paymentUnavailable": "الحجز عبر الإنترنت غير متاح مؤقتاً. يرجى التواصل معنا لإتمام حجزك.",
    "funnel.onlinePayment": "الدفع عبر الإنترنت",
    "funnel.onlinePaymentDesc": "ادفع بأمان بالبطاقة الآن",
    "funnel.cashArrival": "ادفع نقداً عند الوصول",
    "funnel.cashArrivalDesc": "ادفع للسائق نقداً",
    "funnel.proceedPayment": "المتابعة إلى الدفع",
    "funnel.confirmBooking": "تأكيد الحجز",
    "funnel.processing": "جارٍ المعالجة…",
    "funnel.termsAgree": "بتأكيدك فإنك توافق على شروط الخدمة لدينا.",
    "funnel.redirectNote": "ستتم إعادة توجيهك إلى مزوّد الدفع الآمن الخاص بنا.",
    "funnel.payOnArrivalNote": "يتم تحصيل الدفع عند الوصول.",
    "funnel.onlinePaymentRefNote": "ستحصل على رقم مرجعي للحجز لإضافته إلى ملاحظات الدفع لأغراض التتبع.",
    "funnel.paymentRefTitle": "اقتربت من الانتهاء — دوّن رقمك المرجعي",
    "funnel.paymentRefInstruction": "تم حجزك بنجاح. يرجى إضافة الرقم المرجعي للحجز أدناه إلى ملاحظات أو وصف الدفع حتى نتمكن من مطابقة دفعتك بهذا الحجز.",
    "funnel.paymentRefNote": "أضف هذا الرقم المرجعي في ملاحظات الدفع في الشاشة التالية.",
    "funnel.cancellationPolicy": "سياسة الإلغاء",
    "funnel.cancellationPolicyLabel": "سياسة الإلغاء:",
    "funnel.cancellationPolicyText": "إلغاء مجاني حتى 48 ساعة قبل موعد الاستلام المحدد. لا يمكن معالجة الإلغاءات خلال 48 ساعة من المغادرة.",
    "funnel.policiesTitle": "سياسات الإلغاء وعدم الحضور",
    "funnel.noShowPolicy": "سياسة عدم الحضور",
    "funnel.noShowPolicyText": "إذا لم تكن في نقطة الاستلام المتفق عليها في الوقت المحدد ولم يتمكن فريقنا من الوصول إليك، يُعتبر الحجز حالة عدم حضور وغير قابل للاسترداد.",
    "funnel.selectedRoute": "مسارك المحدد",
    "funnel.routeFrom": "من",
    "funnel.routeTo": "إلى",
    "funnel.routeWhen": "الاستلام",
    "funnel.routeReturn": "العودة",
    "funnel.routePassengers": "الركاب",
    // Navigation
    "nav.home": "الرئيسية",
    ...
    "booking.outboundTrip": "رحلة الذهاب",
    "booking.returnTrip": "رحلة العودة",
    ...
    "booking.aiMode": "وضع الذكاء الاصطناعي",
    "booking.aiIntro": "مرحبًا، أنا مساعد ترانسفيرا الذكي 👋 سأساعدك في حجز انتقالك خطوة بخطوة — وصولًا إلى صفحة البيانات الشخصية. فقط صف رحلتك بكلماتك، مثال: «من مطار الغردقة إلى شتايجنبرجر الدو غدًا الساعة 3 مساءً، 4 أشخاص».",
    "booking.aiPlaceholder": "صف رحلتك…",
    "booking.aiSend": "إرسال",
    "booking.aiThinking": "جارٍ التفكير…",
    "booking.aiError": "عذرًا، حدث خطأ ما. حاول مرة أخرى أو استخدم البحث العادي.",
    "booking.aiDisclaimer": "يساعد في حجوزات انتقالات ترانسفيرا فقط.",
    "booking.aiTitle": "مساعد ترانسفيرا الذكي",
    "booking.aiSubtitle": "يحجز انتقالك حتى صفحة البيانات الشخصية",
    "booking.aiMic": "تحدّث",
    "booking.aiListening": "يستمع…",
    "booking.aiVoiceOn": "الردود الصوتية مفعّلة",
    "booking.aiVoiceOff": "الردود الصوتية متوقفة",
    ...
    "track.emailPlaceholder": "البريد الإلكتروني المستخدم في الحجز",
    "track.emailHint": "أدخل رقم الحجز المرجعي والبريد الإلكتروني الذي استخدمته عند الحجز.",
    "track.search": "تتبع",
    ...
    "blog.heading": "مدوّنة Transfera",
    "blog.subheading": "نصائح السفر وأدلة الوجهات وكل ما تحتاجه لرحلة نقل سلسة من المطار في مصر.",
    "blog.read": "اقرأ",
    "blog.empty": "لا توجد مقالات منشورة بعد. تحقّق مرة أخرى قريباً.",
    "blog.backToBlog": "العودة إلى المدوّنة",
    "destinations.heading": "وجهات النقل من المطار في مصر",
    "destinations.subheading": "نقل خاص من وإلى جميع المطارات المصرية الرئيسية. سعر ثابت، تتبع الرحلات، إلغاء مجاني.",
    "destinations.empty": "الوجهات قريباً.",
  ...
  de: {
    // ── Booking funnel ──
    "funnel.step.vehicle": "Fahrzeug wählen",
    "funnel.step.flight": "Flug & Extras",
    "funnel.step.details": "Ihre Angaben",
    "funnel.editSearch": "Suche bearbeiten",
    "funnel.back": "Zurück",
    "funnel.label.arrival": "Ankunft",
    "funnel.label.departure": "Abfahrt",
    "funnel.label.twoWay": "Hin & Zurück",
    "funnel.label.cityToCity": "Stadt zu Stadt",
    "funnel.transferSuffix": "Transfer",
    "funnel.paxCount": "{n} Passagiere",
    "funnel.chooseVehicle": "Wählen Sie Ihr Fahrzeug",
    "funnel.pricesPerVehicle": "Alle Preise gelten pro Fahrzeug, nicht pro Person.",
    "funnel.errNoResults": "Keine Ergebnisse für diese Strecke gefunden.",
    "funnel.errLoad": "Fahrzeuge konnten nicht geladen werden.",
    "funnel.goBackTry": "Zurückgehen und erneut versuchen",
    "funnel.noVehicles": "Keine Fahrzeuge für diese Strecke verfügbar.",
    "funnel.tryDifferent": "Versuchen Sie ein anderes Datum oder eine andere Passagierzahl.",
    "funnel.upTo": "bis zu {n}",
    "funnel.ac": "Klima",
    "funnel.wifi": "WLAN",
    "funnel.gps": "GPS",
    "funnel.manual": "manuell",
    "funnel.automatic": "automatik",
    "funnel.copy": "Kopieren",
    "funnel.copied": "Kopiert!",
    "funnel.copyReference": "Referenz kopieren",
    "funnel.tipAc": "Klimaanlage",
    "funnel.tipWifi": "WLAN an Bord",
    "funnel.tipGps": "GPS-Tracking",
    "funnel.tipTransmission": "Getriebe",
    "funnel.tipLuggage": "Gepäckkapazität",
    "funnel.tipSeats": "Passagierkapazität",
    "funnel.roundTripIncl": "Hin- und Rückfahrt · beide Strecken inklusive",
    "funnel.perVehicleIncl": "Pro Fahrzeug · alles inklusive",
    "funnel.bookNow": "Jetzt buchen",
    "funnel.flightDetails": "Flugdaten",
    "funnel.flightSubArr": "Ihre Ankunftsfluginformationen, damit wir Verspätungen verfolgen können.",
    "funnel.flightSubDep": "Ihre Abfluginformationen zur Terminplanung.",
    "funnel.flightInformation": "Fluginformationen",
    "funnel.flightNumber": "Flugnummer",
    "funnel.terminal": "Terminal",
    "funnel.originFrom": "Abflugort (von)",
    "funnel.destinationTo": "Ziel (nach)",
    "funnel.returnFlight": "Rückflug (Abflug)",
    "funnel.returnFlightNumber": "Rückflugnummer",
    "funnel.yourVehicle": "Ihr Fahrzeug",
    "funnel.capacityN": "Kapazität: {n} Sitze",
    "funnel.bags": "{n} Gepäckstücke",
    "funnel.optionalExtras": "Optionale Extras",
    "funnel.changeVehicle": "Fahrzeug wechseln",
    "funnel.noOtherVehicle": "Kein anderes Fahrzeug auf dieser Strecke kann die ausgewählten Passagiere und Extras befördern.",
    "funnel.occupiesSeat": "belegt einen Sitz",
    "funnel.onlySuffix": "nur {names}",
    "funnel.specialRequests": "Besondere Wünsche",
    "funnel.specialRequestsPh": "Besondere Anforderungen oder Hinweise für den Fahrer…",
    "funnel.yourPrice": "Ihr Preis",
    "funnel.inclExtras": "inkl. {amount} Extras",
    "funnel.paxShort": "{n} Pers.",
    "funnel.continueDetails": "Weiter zu Ihren Angaben",
    "funnel.alertVehicleType": "„{extra}“ kann nur von {names} befördert werden. Wechseln Sie unten Ihr Fahrzeug, um es hinzuzufügen — ohne Ihre Suche neu zu starten.",
    "funnel.alertCapacity": "Dieses {seats}-Sitzer-Fahrzeug ist mit {pax} Passagieren und den bereits gewählten Extras voll. Wechseln Sie unten zu einem größeren Fahrzeug, um „{extra}“ hinzuzufügen — ohne Ihre Suche neu zu starten.",
    "funnel.bookingConfirmed": "Buchung bestätigt!",
    "funnel.yourReference": "Ihre Referenz:",
    "funnel.confirmationSent": "Eine Bestätigung wurde an {email} gesendet",
    "funnel.accountCreated": "Konto für Sie erstellt",
    "funnel.accountDesc": "Melden Sie sich an, um Ihre Buchung zu verwalten, Ihren Fahrer zu verfolgen und Ihre Fahrt zu ändern oder zu stornieren.",
    "funnel.emailUsername": "E-Mail (Benutzername)",
    "funnel.password": "Passwort",
    "funnel.passwordNote": "Ihr Passwort ist Ihre Mobilnummer. Sie können es nach der Anmeldung ändern.",
    "funnel.goToAccount": "Zu meinem Konto",
    "funnel.alreadyAccount": "Sie haben bereits ein Konto? Melden Sie sich an, um Ihre Buchung zu verwalten →",
    "funnel.backHome": "Zurück zur Startseite",
    "funnel.yourDetails": "Ihre Angaben",
    "funnel.confirmationHere": "Wir senden Ihre Buchungsbestätigung hierhin.",
    "funnel.personalInfo": "Persönliche Angaben",
    "funnel.fullName": "Vollständiger Name",
    "funnel.email": "E-Mail",
    "funnel.phone": "Telefon",
    "funnel.country": "Land",
    "funnel.bookingSummary": "Buchungsübersicht",
    "funnel.transfer": "Transfer",
    "funnel.total": "Gesamt",
    "funnel.paymentMethod": "Zahlungsmethode",
    "funnel.paymentUnavailable": "Online-Buchung ist vorübergehend nicht verfügbar. Bitte kontaktieren Sie uns, um Ihre Buchung abzuschließen.",
    "funnel.onlinePayment": "Online-Zahlung",
    "funnel.onlinePaymentDesc": "Jetzt sicher per Karte bezahlen",
    "funnel.cashArrival": "Bei Ankunft bar bezahlen",
    "funnel.cashArrivalDesc": "Bezahlen Sie Ihren Fahrer bar",
    "funnel.proceedPayment": "Weiter zur Zahlung",
    "funnel.confirmBooking": "Buchung bestätigen",
    "funnel.processing": "Wird verarbeitet…",
    "funnel.termsAgree": "Mit der Bestätigung stimmen Sie unseren Nutzungsbedingungen zu.",
    "funnel.redirectNote": "Sie werden zu unserem sicheren Zahlungsanbieter weitergeleitet.",
    "funnel.payOnArrivalNote": "Die Zahlung erfolgt bei Ankunft.",
    "funnel.onlinePaymentRefNote": "Sie erhalten eine Buchungsreferenz, die Sie zur Nachverfolgung in Ihren Zahlungsnotizen angeben können.",
    "funnel.paymentRefTitle": "Fast geschafft — notieren Sie Ihre Referenz",
    "funnel.paymentRefInstruction": "Ihre Buchung ist reserviert. Bitte fügen Sie die untenstehende Buchungsreferenz Ihren Zahlungsnotizen / der Beschreibung hinzu, damit wir Ihre Zahlung dieser Buchung zuordnen können.",
    "funnel.paymentRefNote": "Geben Sie diese Referenz im nächsten Schritt in den Zahlungsnotizen an.",
    "funnel.cancellationPolicy": "Stornierungsbedingungen",
    "funnel.cancellationPolicyLabel": "Stornierungsbedingungen:",
    "funnel.cancellationPolicyText": "Kostenlose Stornierung bis 48 Stunden vor Ihrer geplanten Abholung. Stornierungen innerhalb von 48 Stunden vor Abfahrt können nicht bearbeitet werden.",
    "funnel.policiesTitle": "Stornierungs- und Nichterscheinen-Bedingungen",
    "funnel.noShowPolicy": "Nichterscheinen-Bedingungen",
    "funnel.noShowPolicyText": "Wenn Sie zur vereinbarten Zeit nicht am vereinbarten Abholpunkt sind und unser Team Sie nicht erreichen kann, gilt die Buchung als Nichterscheinen und ist nicht erstattungsfähig.",
    "funnel.selectedRoute": "Ihre ausgewählte Route",
    "funnel.routeFrom": "Von",
    "funnel.routeTo": "Nach",
    "funnel.routeWhen": "Abholung",
    "funnel.routeReturn": "Rückfahrt",
    "funnel.routePassengers": "Passagiere",
    // Navigation
    "nav.home": "Startseite",
    ...
    "booking.outboundTrip": "Hinfahrt",
    "booking.returnTrip": "Rückfahrt",
    "booking.pickup": "Abholung",
    "booking.dropoff": "Zielort",
    "booking.twoWayTransfer": "Hin- & Rücktransfer",
    "booking.cityToCity": "Stadt zu Stadt",
    "booking.aiMode": "KI-Modus",
    "booking.aiIntro": "Hallo, ich bin der Transfera KI-Assistent 👋 Ich helfe Ihnen Schritt für Schritt bei der Buchung Ihres Transfers — bis zur Seite mit den persönlichen Daten. Beschreiben Sie einfach Ihre Fahrt in eigenen Worten, z. B. „Flughafen Hurghada zum Steigenberger Al Dau morgen 15 Uhr, 4 Personen“.",
    "booking.aiPlaceholder": "Beschreiben Sie Ihren Transfer…",
    "booking.aiSend": "Senden",
    "booking.aiThinking": "Denkt nach…",
    "booking.aiError": "Entschuldigung, etwas ist schiefgelaufen. Bitte erneut versuchen oder die normale Suche nutzen.",
    "booking.aiDisclaimer": "Hilft nur bei Transfera-Transferbuchungen.",
    "booking.aiTitle": "Transfera KI-Assistent",
    "booking.aiSubtitle": "Bucht Ihren Transfer bis zur Seite mit den persönlichen Daten",
    "booking.aiMic": "Sprechen",
    "booking.aiListening": "Hört zu…",
    "booking.aiVoiceOn": "Sprachantworten an",
    "booking.aiVoiceOff": "Sprachantworten aus",
    ...
    "track.emailPlaceholder": "Für die Buchung verwendete E-Mail",
    "track.emailHint": "Geben Sie Ihre Buchungsreferenz und die bei der Buchung verwendete E-Mail-Adresse ein.",
    ...
    "blog.heading": "Der Transfera-Blog",
    "blog.subheading": "Reisetipps, Reiseführer und alles, was Sie für einen reibungslosen Flughafentransfer in Ägypten brauchen.",
    "blog.read": "Lesen",
    "blog.empty": "Noch keine Artikel veröffentlicht. Schauen Sie bald wieder vorbei.",
    "blog.backToBlog": "Zurück zum Blog",
    "destinations.heading": "Flughafentransfer-Ziele in Ägypten",
    "destinations.subheading": "Private Transfers zu und von allen großen ägyptischen Flughäfen. Festpreis, Flugverfolgung, kostenlose Stornierung.",
    "destinations.empty": "Ziele folgen in Kürze.",
    // Airport Coverage & FAQ sections
  ...
  fr: {
    // ── Booking funnel ──
    "funnel.step.vehicle": "Choisir le véhicule",
    "funnel.step.flight": "Vol & extras",
    "funnel.step.details": "Vos coordonnées",
    "funnel.editSearch": "Modifier la recherche",
    "funnel.back": "Retour",
    "funnel.label.arrival": "Arrivée",
    "funnel.label.departure": "Départ",
    "funnel.label.twoWay": "Aller-retour",
    "funnel.label.cityToCity": "Ville à ville",
    "funnel.transferSuffix": "Transfert",
    "funnel.paxCount": "{n} passagers",
    "funnel.chooseVehicle": "Choisissez votre véhicule",
    "funnel.pricesPerVehicle": "Tous les prix sont par véhicule, pas par personne.",
    "funnel.errNoResults": "Aucun résultat trouvé pour cet itinéraire.",
    "funnel.errLoad": "Échec du chargement des véhicules.",
    "funnel.goBackTry": "Revenir en arrière et réessayer",
    "funnel.noVehicles": "Aucun véhicule disponible pour cet itinéraire.",
    "funnel.tryDifferent": "Essayez une autre date ou un autre nombre de passagers.",
    "funnel.upTo": "jusqu'à {n}",
    "funnel.ac": "Clim",
    "funnel.wifi": "Wi-Fi",
    "funnel.gps": "GPS",
    "funnel.manual": "manuelle",
    "funnel.automatic": "automatique",
    "funnel.copy": "Copier",
    "funnel.copied": "Copié !",
    "funnel.copyReference": "Copier la référence",
    "funnel.tipAc": "Climatisation",
    "funnel.tipWifi": "Wi-Fi à bord",
    "funnel.tipGps": "Suivi GPS",
    "funnel.tipTransmission": "Transmission",
    "funnel.tipLuggage": "Capacité bagages",
    "funnel.tipSeats": "Capacité passagers",
    "funnel.roundTripIncl": "Aller-retour · les deux trajets inclus",
    "funnel.perVehicleIncl": "Par véhicule · tout compris",
    "funnel.bookNow": "Réserver",
    "funnel.flightDetails": "Détails du vol",
    "funnel.flightSubArr": "Les informations de votre vol d'arrivée pour que nous puissions suivre les retards.",
    "funnel.flightSubDep": "Les informations de votre vol de départ pour la planification.",
    "funnel.flightInformation": "Informations sur le vol",
    "funnel.flightNumber": "Numéro de vol",
    "funnel.terminal": "Terminal",
    "funnel.originFrom": "Provenance (en provenance de)",
    "funnel.destinationTo": "Destination (à destination de)",
    "funnel.returnFlight": "Vol retour (départ)",
    "funnel.returnFlightNumber": "Numéro du vol retour",
    "funnel.yourVehicle": "Votre véhicule",
    "funnel.capacityN": "Capacité : {n} sièges",
    "funnel.bags": "{n} bagages",
    "funnel.optionalExtras": "Extras en option",
    "funnel.changeVehicle": "Changer de véhicule",
    "funnel.noOtherVehicle": "Aucun autre véhicule sur cet itinéraire ne peut transporter les passagers et les extras sélectionnés.",
    "funnel.occupiesSeat": "occupe un siège",
    "funnel.onlySuffix": "{names} uniquement",
    "funnel.specialRequests": "Demandes spéciales",
    "funnel.specialRequestsPh": "Toute exigence particulière ou note pour le chauffeur…",
    "funnel.yourPrice": "Votre prix",
    "funnel.inclExtras": "dont {amount} d'extras",
    "funnel.paxShort": "{n} pers.",
    "funnel.continueDetails": "Continuer vers vos coordonnées",
    "funnel.alertVehicleType": "« {extra} » ne peut être transporté que par {names}. Changez votre véhicule ci-dessous pour l'ajouter — sans recommencer votre recherche.",
    "funnel.alertCapacity": "Ce véhicule de {seats} places est complet avec {pax} passagers et les extras déjà sélectionnés. Passez à un véhicule plus grand ci-dessous pour ajouter « {extra} » — sans recommencer votre recherche.",
    "funnel.bookingConfirmed": "Réservation confirmée !",
    "funnel.yourReference": "Votre référence :",
    "funnel.confirmationSent": "Une confirmation a été envoyée à {email}",
    "funnel.accountCreated": "Un compte a été créé pour vous",
    "funnel.accountDesc": "Connectez-vous pour gérer votre réservation, suivre votre chauffeur et modifier ou annuler votre trajet.",
    "funnel.emailUsername": "E-mail (identifiant)",
    "funnel.password": "Mot de passe",
    "funnel.passwordNote": "Votre mot de passe est votre numéro de mobile. Vous pouvez le changer après connexion.",
    "funnel.goToAccount": "Accéder à mon compte",
    "funnel.alreadyAccount": "Vous avez déjà un compte ? Connectez-vous pour gérer votre réservation →",
    "funnel.backHome": "Retour à l'accueil",
    "funnel.yourDetails": "Vos coordonnées",
    "funnel.confirmationHere": "Nous enverrons votre confirmation de réservation ici.",
    "funnel.personalInfo": "Informations personnelles",
    "funnel.fullName": "Nom complet",
    "funnel.email": "E-mail",
    "funnel.phone": "Téléphone",
    "funnel.country": "Pays",
    "funnel.bookingSummary": "Récapitulatif de la réservation",
    "funnel.transfer": "Transfert",
    "funnel.total": "Total",
    "funnel.paymentMethod": "Mode de paiement",
    "funnel.paymentUnavailable": "La réservation en ligne est temporairement indisponible. Veuillez nous contacter pour finaliser votre réservation.",
    "funnel.onlinePayment": "Paiement en ligne",
    "funnel.onlinePaymentDesc": "Payez en toute sécurité par carte maintenant",
    "funnel.cashArrival": "Payer en espèces à l'arrivée",
    "funnel.cashArrivalDesc": "Payez votre chauffeur en espèces",
    "funnel.proceedPayment": "Procéder au paiement",
    "funnel.confirmBooking": "Confirmer la réservation",
    "funnel.processing": "Traitement…",
    "funnel.termsAgree": "En confirmant, vous acceptez nos conditions d'utilisation.",
    "funnel.redirectNote": "Vous serez redirigé vers notre prestataire de paiement sécurisé.",
    "funnel.payOnArrivalNote": "Le paiement est perçu à l'arrivée.",
    "funnel.onlinePaymentRefNote": "Vous recevrez une référence de réservation à ajouter à vos notes de paiement pour le suivi.",
    "funnel.paymentRefTitle": "Presque terminé — notez votre référence",
    "funnel.paymentRefInstruction": "Votre réservation est confirmée. Veuillez ajouter la référence de réservation ci-dessous à vos notes / description de paiement afin que nous puissions associer votre paiement à cette réservation.",
    "funnel.paymentRefNote": "Ajoutez cette référence dans les notes de paiement à l'écran suivant.",
    "funnel.cancellationPolicy": "Politique d'annulation",
    "funnel.cancellationPolicyLabel": "Politique d'annulation :",
    "funnel.cancellationPolicyText": "Annulation gratuite jusqu'à 48 heures avant votre prise en charge prévue. Les annulations dans les 48 heures précédant le départ ne peuvent pas être traitées.",
    "funnel.policiesTitle": "Conditions d'annulation et de non-présentation",
    "funnel.noShowPolicy": "Politique de non-présentation",
    "funnel.noShowPolicyText": "Si vous n'êtes pas au point de prise en charge convenu à l'heure prévue et que notre équipe ne parvient pas à vous joindre, la réservation est considérée comme une non-présentation et n'est pas remboursable.",
    "funnel.selectedRoute": "Votre trajet sélectionné",
    "funnel.routeFrom": "De",
    "funnel.routeTo": "À",
    "funnel.routeWhen": "Prise en charge",
    "funnel.routeReturn": "Retour",
    "funnel.routePassengers": "Passagers",
    // Navigation
    "nav.home": "Accueil",
    ...
    "booking.outboundTrip": "Aller",
    "booking.returnTrip": "Retour",
    ...
    "booking.aiMode": "Mode IA",
    "booking.aiIntro": "Bonjour, je suis l'Assistant IA Transfera 👋 Je vous aide à réserver votre transfert étape par étape — jusqu'à la page des informations personnelles. Décrivez simplement votre trajet avec vos mots, par ex. « Aéroport d'Hurghada vers Steigenberger Al Dau demain 15h, 4 personnes ».",
    "booking.aiPlaceholder": "Décrivez votre transfert…",
    "booking.aiSend": "Envoyer",
    "booking.aiThinking": "Réflexion…",
    "booking.aiError": "Désolé, une erreur s'est produite. Réessayez ou utilisez la recherche standard.",
    "booking.aiDisclaimer": "Aide uniquement pour les réservations de transfert Transfera.",
    "booking.aiTitle": "Assistant IA Transfera",
    "booking.aiSubtitle": "Réserve votre transfert jusqu'à la page des informations personnelles",
    "booking.aiMic": "Parler",
    "booking.aiListening": "À l'écoute…",
    "booking.aiVoiceOn": "Réponses vocales activées",
    "booking.aiVoiceOff": "Réponses vocales désactivées",
    ...
    "track.emailPlaceholder": "E-mail utilisé pour réserver",
    "track.emailHint": "Saisissez votre référence de réservation et l'adresse e-mail utilisée lors de la réservation.",
    "track.search": "Suivre",
    ...
    "blog.heading": "Le blog Transfera",
    "blog.subheading": "Conseils de voyage, guides de destinations et tout ce qu'il faut pour un transfert aéroport sans souci en Égypte.",
    "blog.read": "Lire",
    "blog.empty": "Aucun article publié pour le moment. Revenez bientôt.",
    "blog.backToBlog": "Retour au blog",
    "destinations.heading": "Destinations de transfert aéroport en Égypte",
    "destinations.subheading": "Transferts privés vers et depuis tous les grands aéroports égyptiens. Prix fixe, suivi des vols, annulation gratuite.",
    "destinations.empty": "Destinations bientôt disponibles.",
    // Airport Coverage & FAQ sections
  ...
  it: {
    // ── Booking funnel ──
    "funnel.step.vehicle": "Scegli il veicolo",
    "funnel.step.flight": "Volo ed extra",
    "funnel.step.details": "I tuoi dati",
    "funnel.editSearch": "Modifica ricerca",
    "funnel.back": "Indietro",
    "funnel.label.arrival": "Arrivo",
    "funnel.label.departure": "Partenza",
    "funnel.label.twoWay": "Andata e ritorno",
    "funnel.label.cityToCity": "Città a città",
    "funnel.transferSuffix": "Transfer",
    "funnel.paxCount": "{n} passeggeri",
    "funnel.chooseVehicle": "Scegli il tuo veicolo",
    "funnel.pricesPerVehicle": "Tutti i prezzi sono per veicolo, non per persona.",
    "funnel.errNoResults": "Nessun risultato trovato per questo percorso.",
    "funnel.errLoad": "Impossibile caricare i veicoli.",
    "funnel.goBackTry": "Torna indietro e riprova",
    "funnel.noVehicles": "Nessun veicolo disponibile per questo percorso.",
    "funnel.tryDifferent": "Prova una data diversa o un numero di passeggeri diverso.",
    "funnel.upTo": "fino a {n}",
    "funnel.ac": "Aria cond.",
    "funnel.wifi": "Wi-Fi",
    "funnel.gps": "GPS",
    "funnel.manual": "manuale",
    "funnel.automatic": "automatico",
    "funnel.copy": "Copia",
    "funnel.copied": "Copiato!",
    "funnel.copyReference": "Copia riferimento",
    "funnel.tipAc": "Aria condizionata",
    "funnel.tipWifi": "Wi-Fi a bordo",
    "funnel.tipGps": "Tracciamento GPS",
    "funnel.tipTransmission": "Cambio",
    "funnel.tipLuggage": "Capacità bagagli",
    "funnel.tipSeats": "Capacità passeggeri",
    "funnel.roundTripIncl": "Andata e ritorno · entrambe le tratte incluse",
    "funnel.perVehicleIncl": "Per veicolo · tutto incluso",
    "funnel.bookNow": "Prenota ora",
    "funnel.flightDetails": "Dettagli del volo",
    "funnel.flightSubArr": "Le informazioni del tuo volo in arrivo per poter monitorare i ritardi.",
    "funnel.flightSubDep": "Le informazioni del tuo volo in partenza per la pianificazione.",
    "funnel.flightInformation": "Informazioni sul volo",
    "funnel.flightNumber": "Numero del volo",
    "funnel.terminal": "Terminal",
    "funnel.originFrom": "Origine (in partenza da)",
    "funnel.destinationTo": "Destinazione (diretto a)",
    "funnel.returnFlight": "Volo di ritorno (partenza)",
    "funnel.returnFlightNumber": "Numero del volo di ritorno",
    "funnel.yourVehicle": "Il tuo veicolo",
    "funnel.capacityN": "Capacità: {n} posti",
    "funnel.bags": "{n} bagagli",
    "funnel.optionalExtras": "Extra opzionali",
    "funnel.changeVehicle": "Cambia veicolo",
    "funnel.noOtherVehicle": "Nessun altro veicolo su questo percorso può trasportare i passeggeri e gli extra selezionati.",
    "funnel.occupiesSeat": "occupa un posto",
    "funnel.onlySuffix": "solo {names}",
    "funnel.specialRequests": "Richieste speciali",
    "funnel.specialRequestsPh": "Eventuali requisiti speciali o note per l'autista…",
    "funnel.yourPrice": "Il tuo prezzo",
    "funnel.inclExtras": "incl. {amount} di extra",
    "funnel.paxShort": "{n} pers.",
    "funnel.continueDetails": "Continua con i tuoi dati",
    "funnel.alertVehicleType": "«{extra}» può essere trasportato solo da {names}. Cambia il tuo veicolo qui sotto per aggiungerlo — senza ricominciare la ricerca.",
    "funnel.alertCapacity": "Questo veicolo da {seats} posti è al completo con {pax} passeggeri e gli extra già selezionati. Passa a un veicolo più grande qui sotto per aggiungere «{extra}» — senza ricominciare la ricerca.",
    "funnel.bookingConfirmed": "Prenotazione confermata!",
    "funnel.yourReference": "Il tuo riferimento:",
    "funnel.confirmationSent": "Una conferma è stata inviata a {email}",
    "funnel.accountCreated": "Account creato per te",
    "funnel.accountDesc": "Accedi per gestire la tua prenotazione, seguire il tuo autista e modificare o annullare il tuo viaggio.",
    "funnel.emailUsername": "Email (nome utente)",
    "funnel.password": "Password",
    "funnel.passwordNote": "La tua password è il tuo numero di cellulare. Puoi cambiarla dopo l'accesso.",
    "funnel.goToAccount": "Vai al mio account",
    "funnel.alreadyAccount": "Hai già un account? Accedi per gestire la tua prenotazione →",
    "funnel.backHome": "Torna alla home",
    "funnel.yourDetails": "I tuoi dati",
    "funnel.confirmationHere": "Invieremo qui la conferma della tua prenotazione.",
    "funnel.personalInfo": "Informazioni personali",
    "funnel.fullName": "Nome completo",
    "funnel.email": "Email",
    "funnel.phone": "Telefono",
    "funnel.country": "Paese",
    "funnel.bookingSummary": "Riepilogo della prenotazione",
    "funnel.transfer": "Transfer",
    "funnel.total": "Totale",
    "funnel.paymentMethod": "Metodo di pagamento",
    "funnel.paymentUnavailable": "La prenotazione online è temporaneamente non disponibile. Contattaci per completare la tua prenotazione.",
    "funnel.onlinePayment": "Pagamento online",
    "funnel.onlinePaymentDesc": "Paga in sicurezza con carta ora",
    "funnel.cashArrival": "Paga in contanti all'arrivo",
    "funnel.cashArrivalDesc": "Paga il tuo autista in contanti",
    "funnel.proceedPayment": "Procedi al pagamento",
    "funnel.confirmBooking": "Conferma prenotazione",
    "funnel.processing": "Elaborazione…",
    "funnel.termsAgree": "Confermando accetti i nostri termini di servizio.",
    "funnel.redirectNote": "Verrai reindirizzato al nostro fornitore di pagamento sicuro.",
    "funnel.payOnArrivalNote": "Il pagamento viene riscosso all'arrivo.",
    "funnel.onlinePaymentRefNote": "Riceverai un riferimento di prenotazione da aggiungere alle note di pagamento per il tracciamento.",
    "funnel.paymentRefTitle": "Quasi fatto — annota il tuo riferimento",
    "funnel.paymentRefInstruction": "La tua prenotazione è confermata. Aggiungi il riferimento di prenotazione qui sotto alle note / descrizione del pagamento, così possiamo associare il tuo pagamento a questa prenotazione.",
    "funnel.paymentRefNote": "Aggiungi questo riferimento nelle note di pagamento nella schermata successiva.",
    "funnel.cancellationPolicy": "Politica di cancellazione",
    "funnel.cancellationPolicyLabel": "Politica di cancellazione:",
    "funnel.cancellationPolicyText": "Cancellazione gratuita fino a 48 ore prima del ritiro previsto. Le cancellazioni entro 48 ore dalla partenza non possono essere elaborate.",
    "funnel.policiesTitle": "Politiche di cancellazione e mancata presentazione",
    "funnel.noShowPolicy": "Politica di mancata presentazione",
    "funnel.noShowPolicyText": "Se non sei al punto di ritiro concordato all'orario previsto e il nostro team non riesce a contattarti, la prenotazione è considerata una mancata presentazione e non è rimborsabile.",
    "funnel.selectedRoute": "Il tuo percorso selezionato",
    "funnel.routeFrom": "Da",
    "funnel.routeTo": "A",
    "funnel.routeWhen": "Ritiro",
    "funnel.routeReturn": "Ritorno",
    "funnel.routePassengers": "Passeggeri",
    // Navigation
    "nav.home": "Home",
    ...
    "booking.outboundTrip": "Andata",
    "booking.returnTrip": "Ritorno",
    ...
    "booking.aiMode": "Modalità IA",
    "booking.aiIntro": "Ciao, sono l'Assistente IA Transfera 👋 Ti aiuto a prenotare il tuo transfer passo dopo passo — fino alla pagina dei dati personali. Descrivi semplicemente il tuo viaggio con parole tue, es. « Aeroporto di Hurghada allo Steigenberger Al Dau domani alle 15, 4 persone ».",
    "booking.aiPlaceholder": "Descrivi il tuo transfer…",
    "booking.aiSend": "Invia",
    "booking.aiThinking": "Sto pensando…",
    "booking.aiError": "Spiacenti, qualcosa è andato storto. Riprova o usa la ricerca standard.",
    "booking.aiDisclaimer": "Assiste solo con le prenotazioni di transfer Transfera.",
    "booking.aiTitle": "Assistente IA Transfera",
    "booking.aiSubtitle": "Prenota il tuo transfer fino alla pagina dei dati personali",
    "booking.aiMic": "Parla",
    "booking.aiListening": "In ascolto…",
    "booking.aiVoiceOn": "Risposte vocali attive",
    "booking.aiVoiceOff": "Risposte vocali disattivate",
    ...
    "track.emailPlaceholder": "Email usata per prenotare",
    "track.emailHint": "Inserisci il tuo riferimento di prenotazione e l'indirizzo email usato al momento della prenotazione.",
    ...
    "blog.heading": "Il blog di Transfera",
    "blog.subheading": "Consigli di viaggio, guide alle destinazioni e tutto ciò che serve per un transfer aeroportuale senza pensieri in Egitto.",
    "blog.read": "Leggi",
    "blog.empty": "Nessun articolo pubblicato per ora. Torna presto.",
    "blog.backToBlog": "Torna al blog",
    "destinations.heading": "Destinazioni dei transfer aeroportuali in Egitto",
    "destinations.subheading": "Transfer privati da e per tutti i principali aeroporti egiziani. Prezzo fisso, monitoraggio voli, cancellazione gratuita.",
    "destinations.empty": "Destinazioni in arrivo.",
    // Airport Coverage & FAQ sections
  ...
  nl: {
    // ── Booking funnel ──
    "funnel.step.vehicle": "Voertuig kiezen",
    "funnel.step.flight": "Vlucht & extra's",
    "funnel.step.details": "Uw gegevens",
    "funnel.editSearch": "Zoekopdracht aanpassen",
    "funnel.back": "Terug",
    "funnel.label.arrival": "Aankomst",
    "funnel.label.departure": "Vertrek",
    "funnel.label.twoWay": "Heen & terug",
    "funnel.label.cityToCity": "Stad naar stad",
    "funnel.transferSuffix": "Transfer",
    "funnel.paxCount": "{n} passagiers",
    "funnel.chooseVehicle": "Kies uw voertuig",
    "funnel.pricesPerVehicle": "Alle prijzen zijn per voertuig, niet per persoon.",
    "funnel.errNoResults": "Geen resultaten gevonden voor deze route.",
    "funnel.errLoad": "Voertuigen konden niet worden geladen.",
    "funnel.goBackTry": "Ga terug en probeer opnieuw",
    "funnel.noVehicles": "Geen voertuigen beschikbaar voor deze route.",
    "funnel.tryDifferent": "Probeer een andere datum of een ander aantal passagiers.",
    "funnel.upTo": "tot {n}",
    "funnel.ac": "Airco",
    "funnel.wifi": "Wifi",
    "funnel.gps": "GPS",
    "funnel.manual": "handgeschakeld",
    "funnel.automatic": "automaat",
    "funnel.copy": "Kopiëren",
    "funnel.copied": "Gekopieerd!",
    "funnel.copyReference": "Referentie kopiëren",
    "funnel.tipAc": "Airconditioning",
    "funnel.tipWifi": "Wifi aan boord",
    "funnel.tipGps": "GPS-tracking",
    "funnel.tipTransmission": "Transmissie",
    "funnel.tipLuggage": "Bagagecapaciteit",
    "funnel.tipSeats": "Passagierscapaciteit",
    "funnel.roundTripIncl": "Heen en terug · beide ritten inbegrepen",
    "funnel.perVehicleIncl": "Per voertuig · alles inbegrepen",
    "funnel.bookNow": "Nu boeken",
    "funnel.flightDetails": "Vluchtgegevens",
    "funnel.flightSubArr": "Uw aankomstvluchtgegevens zodat we vertragingen kunnen volgen.",
    "funnel.flightSubDep": "Uw vertrekvluchtgegevens voor de planning.",
    "funnel.flightInformation": "Vluchtinformatie",
    "funnel.flightNumber": "Vluchtnummer",
    "funnel.terminal": "Terminal",
    "funnel.originFrom": "Vertrek (vliegend vanaf)",
    "funnel.destinationTo": "Bestemming (vliegend naar)",
    "funnel.returnFlight": "Retourvlucht (vertrek)",
    "funnel.returnFlightNumber": "Retourvluchtnummer",
    "funnel.yourVehicle": "Uw voertuig",
    "funnel.capacityN": "Capaciteit: {n} stoelen",
    "funnel.bags": "{n} koffers",
    "funnel.optionalExtras": "Optionele extra's",
    "funnel.changeVehicle": "Voertuig wijzigen",
    "funnel.noOtherVehicle": "Geen ander voertuig op deze route kan de geselecteerde passagiers en extra's vervoeren.",
    "funnel.occupiesSeat": "neemt een stoel in beslag",
    "funnel.onlySuffix": "alleen {names}",
    "funnel.specialRequests": "Speciale verzoeken",
    "funnel.specialRequestsPh": "Eventuele speciale wensen of opmerkingen voor de chauffeur…",
    "funnel.yourPrice": "Uw prijs",
    "funnel.inclExtras": "incl. {amount} aan extra's",
    "funnel.paxShort": "{n} pers.",
    "funnel.continueDetails": "Verder naar uw gegevens",
    "funnel.alertVehicleType": "\"{extra}\" kan alleen worden vervoerd door {names}. Wijzig hieronder uw voertuig om het toe te voegen — zonder uw zoekopdracht opnieuw te starten.",
    "funnel.alertCapacity": "Dit voertuig met {seats} stoelen zit vol met {pax} passagiers en de reeds geselecteerde extra's. Kies hieronder een groter voertuig om \"{extra}\" toe te voegen — zonder uw zoekopdracht opnieuw te starten.",
    "funnel.bookingConfirmed": "Boeking bevestigd!",
    "funnel.yourReference": "Uw referentie:",
    "funnel.confirmationSent": "Een bevestiging is verzonden naar {email}",
    "funnel.accountCreated": "Account voor u aangemaakt",
    "funnel.accountDesc": "Log in om uw boeking te beheren, uw chauffeur te volgen en uw rit te wijzigen of te annuleren.",
    "funnel.emailUsername": "E-mail (gebruikersnaam)",
    "funnel.password": "Wachtwoord",
    "funnel.passwordNote": "Uw wachtwoord is uw mobiele nummer. U kunt het wijzigen na het inloggen.",
    "funnel.goToAccount": "Naar mijn account",
    "funnel.alreadyAccount": "Heeft u al een account? Log in om uw boeking te beheren →",
    "funnel.backHome": "Terug naar home",
    "funnel.yourDetails": "Uw gegevens",
    "funnel.confirmationHere": "We sturen uw boekingsbevestiging hierheen.",
    "funnel.personalInfo": "Persoonlijke gegevens",
    "funnel.fullName": "Volledige naam",
    "funnel.email": "E-mail",
    "funnel.phone": "Telefoon",
    "funnel.country": "Land",
    "funnel.bookingSummary": "Boekingsoverzicht",
    "funnel.transfer": "Transfer",
    "funnel.total": "Totaal",
    "funnel.paymentMethod": "Betaalmethode",
    "funnel.paymentUnavailable": "Online boeken is tijdelijk niet beschikbaar. Neem contact met ons op om uw boeking te voltooien.",
    "funnel.onlinePayment": "Online betaling",
    "funnel.onlinePaymentDesc": "Betaal nu veilig met kaart",
    "funnel.cashArrival": "Contant betalen bij aankomst",
    "funnel.cashArrivalDesc": "Betaal uw chauffeur contant",
    "funnel.proceedPayment": "Ga verder naar betaling",
    "funnel.confirmBooking": "Boeking bevestigen",
    "funnel.processing": "Bezig met verwerken…",
    "funnel.termsAgree": "Door te bevestigen gaat u akkoord met onze servicevoorwaarden.",
    "funnel.redirectNote": "U wordt doorgestuurd naar onze beveiligde betaalprovider.",
    "funnel.payOnArrivalNote": "Betaling wordt bij aankomst geïnd.",
    "funnel.onlinePaymentRefNote": "U ontvangt een boekingsreferentie die u voor het volgen aan uw betalingsnotities kunt toevoegen.",
    "funnel.paymentRefTitle": "Bijna klaar — noteer uw referentie",
    "funnel.paymentRefInstruction": "Uw boeking is gereserveerd. Voeg de onderstaande boekingsreferentie toe aan uw betalingsnotities / omschrijving, zodat wij uw betaling aan deze boeking kunnen koppelen.",
    "funnel.paymentRefNote": "Voeg deze referentie toe aan de betalingsnotities op het volgende scherm.",
    "funnel.cancellationPolicy": "Annuleringsbeleid",
    "funnel.cancellationPolicyLabel": "Annuleringsbeleid:",
    "funnel.cancellationPolicyText": "Gratis annuleren tot 48 uur voor uw geplande ophaaltijd. Annuleringen binnen 48 uur voor vertrek kunnen niet worden verwerkt.",
    "funnel.policiesTitle": "Annulerings- en no-showbeleid",
    "funnel.noShowPolicy": "No-showbeleid",
    "funnel.noShowPolicyText": "Als u op het afgesproken tijdstip niet op het afgesproken ophaalpunt bent en ons team u niet kan bereiken, wordt de boeking als no-show beschouwd en is deze niet-restitueerbaar.",
    "funnel.selectedRoute": "Uw geselecteerde route",
    "funnel.routeFrom": "Van",
    "funnel.routeTo": "Naar",
    "funnel.routeWhen": "Ophalen",
    "funnel.routeReturn": "Terugreis",
    "funnel.routePassengers": "Passagiers",
    // Navigation
    "nav.home": "Home",
    ...
    "booking.outboundTrip": "Heenreis",
    "booking.returnTrip": "Terugreis",
    ...
    "booking.aiMode": "AI-modus",
    "booking.aiIntro": "Hoi, ik ben de Transfera AI-assistent 👋 Ik help je stap voor stap met het boeken van je transfer — tot aan de pagina met persoonlijke gegevens. Beschrijf gewoon je rit in je eigen woorden, bijv. 'Luchthaven Hurghada naar Steigenberger Al Dau morgen 15:00 uur, 4 personen'.",
    "booking.aiPlaceholder": "Beschrijf je transfer…",
    "booking.aiSend": "Versturen",
    "booking.aiThinking": "Aan het nadenken…",
    "booking.aiError": "Sorry, er ging iets mis. Probeer het opnieuw of gebruik de standaardzoekfunctie.",
    "booking.aiDisclaimer": "Helpt alleen met Transfera-transferboekingen.",
    "booking.aiTitle": "Transfera AI-assistent",
    "booking.aiSubtitle": "Boekt je transfer tot aan de pagina met persoonlijke gegevens",
    "booking.aiMic": "Spreken",
    "booking.aiListening": "Luistert…",
    "booking.aiVoiceOn": "Gesproken antwoorden aan",
    "booking.aiVoiceOff": "Gesproken antwoorden uit",
    ...
    "track.emailPlaceholder": "E-mail gebruikt bij boeking",
    "track.emailHint": "Voer uw boekingsreferentie in en het e-mailadres dat u bij het boeken hebt gebruikt.",
    "track.search": "Volgen",
    ...
    "blog.heading": "De Transfera-blog",
    "blog.subheading": "Reistips, bestemmingsgidsen en alles wat u nodig heeft voor een soepele luchthaventransfer in Egypte.",
    "blog.read": "Lezen",
    "blog.empty": "Nog geen artikelen gepubliceerd. Kom binnenkort terug.",
    "blog.backToBlog": "Terug naar blog",
    "destinations.heading": "Luchthaventransfer-bestemmingen in Egypte",
    "destinations.subheading": "Privétransfers van en naar elke grote Egyptische luchthaven. Vaste prijs, vluchtvolging, gratis annulering.",
    "destinations.empty": "Bestemmingen binnenkort beschikbaar.",
    // Airport Coverage & FAQ sections
  ...
  ru: {
    // ── Booking funnel ──
    "funnel.step.vehicle": "Выбор автомобиля",
    "funnel.step.flight": "Рейс и доп. услуги",
    "funnel.step.details": "Ваши данные",
    "funnel.editSearch": "Изменить поиск",
    "funnel.back": "Назад",
    "funnel.label.arrival": "Прибытие",
    "funnel.label.departure": "Отправление",
    "funnel.label.twoWay": "Туда-обратно",
    "funnel.label.cityToCity": "Из города в город",
    "funnel.transferSuffix": "трансфер",
    "funnel.paxCount": "{n} пассажиров",
    "funnel.chooseVehicle": "Выберите автомобиль",
    "funnel.pricesPerVehicle": "Все цены указаны за автомобиль, а не за человека.",
    "funnel.errNoResults": "По этому маршруту ничего не найдено.",
    "funnel.errLoad": "Не удалось загрузить автомобили.",
    "funnel.goBackTry": "Вернуться и попробовать снова",
    "funnel.noVehicles": "Нет доступных автомобилей для этого маршрута.",
    "funnel.tryDifferent": "Попробуйте другую дату или другое число пассажиров.",
    "funnel.upTo": "до {n}",
    "funnel.ac": "Кондиционер",
    "funnel.wifi": "Wi-Fi",
    "funnel.gps": "GPS",
    "funnel.manual": "механика",
    "funnel.automatic": "автомат",
    "funnel.copy": "Копировать",
    "funnel.copied": "Скопировано!",
    "funnel.copyReference": "Копировать номер",
    "funnel.tipAc": "Кондиционер",
    "funnel.tipWifi": "Wi-Fi в салоне",
    "funnel.tipGps": "GPS-отслеживание",
    "funnel.tipTransmission": "Коробка передач",
    "funnel.tipLuggage": "Вместимость багажа",
    "funnel.tipSeats": "Вместимость пассажиров",
    "funnel.roundTripIncl": "Туда и обратно · обе поездки включены",
    "funnel.perVehicleIncl": "За автомобиль · всё включено",
    "funnel.bookNow": "Забронировать",
    "funnel.flightDetails": "Данные о рейсе",
    "funnel.flightSubArr": "Данные вашего рейса прибытия, чтобы мы могли отслеживать задержки.",
    "funnel.flightSubDep": "Данные вашего рейса вылета для планирования.",
    "funnel.flightInformation": "Информация о рейсе",
    "funnel.flightNumber": "Номер рейса",
    "funnel.terminal": "Терминал",
    "funnel.originFrom": "Откуда (вылет из)",
    "funnel.destinationTo": "Назначение (вылет в)",
    "funnel.returnFlight": "Обратный рейс (вылет)",
    "funnel.returnFlightNumber": "Номер обратного рейса",
    "funnel.yourVehicle": "Ваш автомобиль",
    "funnel.capacityN": "Вместимость: {n} мест",
    "funnel.bags": "{n} мест багажа",
    "funnel.optionalExtras": "Дополнительные услуги",
    "funnel.changeVehicle": "Сменить автомобиль",
    "funnel.noOtherVehicle": "Ни один другой автомобиль на этом маршруте не может перевезти выбранных пассажиров и дополнительные услуги.",
    "funnel.occupiesSeat": "занимает место",
    "funnel.onlySuffix": "только {names}",
    "funnel.specialRequests": "Особые пожелания",
    "funnel.specialRequestsPh": "Любые особые требования или примечания для водителя…",
    "funnel.yourPrice": "Ваша цена",
    "funnel.inclExtras": "вкл. {amount} за доп. услуги",
    "funnel.paxShort": "{n} чел.",
    "funnel.continueDetails": "Перейти к вашим данным",
    "funnel.alertVehicleType": "«{extra}» может перевозить только {names}. Смените автомобиль ниже, чтобы добавить это — без повторного поиска.",
    "funnel.alertCapacity": "Этот {seats}-местный автомобиль заполнен: {pax} пассажиров и уже выбранные доп. услуги. Выберите автомобиль большего размера ниже, чтобы добавить «{extra}» — без повторного поиска.",
    "funnel.bookingConfirmed": "Бронирование подтверждено!",
    "funnel.yourReference": "Ваш номер:",
    "funnel.confirmationSent": "Подтверждение отправлено на {email}",
    "funnel.accountCreated": "Для вас создан аккаунт",
    "funnel.accountDesc": "Войдите, чтобы управлять бронированием, отслеживать водителя и изменять или отменять поездку.",
    "funnel.emailUsername": "Эл. почта (логин)",
    "funnel.password": "Пароль",
    "funnel.passwordNote": "Ваш пароль — это номер вашего мобильного телефона. Вы можете изменить его после входа.",
    "funnel.goToAccount": "Перейти в мой аккаунт",
    "funnel.alreadyAccount": "Уже есть аккаунт? Войдите, чтобы управлять бронированием →",
    "funnel.backHome": "На главную",
    "funnel.yourDetails": "Ваши данные",
    "funnel.confirmationHere": "Мы отправим подтверждение бронирования сюда.",
    "funnel.personalInfo": "Личные данные",
    "funnel.fullName": "Полное имя",
    "funnel.email": "Эл. почта",
    "funnel.phone": "Телефон",
    "funnel.country": "Страна",
    "funnel.bookingSummary": "Сводка бронирования",
    "funnel.transfer": "Трансфер",
    "funnel.total": "Итого",
    "funnel.paymentMethod": "Способ оплаты",
    "funnel.paymentUnavailable": "Онлайн-бронирование временно недоступно. Пожалуйста, свяжитесь с нами, чтобы завершить бронирование.",
    "funnel.onlinePayment": "Онлайн-оплата",
    "funnel.onlinePaymentDesc": "Оплатите картой безопасно сейчас",
    "funnel.cashArrival": "Оплата наличными по прибытии",
    "funnel.cashArrivalDesc": "Оплатите водителю наличными",
    "funnel.proceedPayment": "Перейти к оплате",
    "funnel.confirmBooking": "Подтвердить бронирование",
    "funnel.processing": "Обработка…",
    "funnel.termsAgree": "Подтверждая, вы соглашаетесь с нашими условиями обслуживания.",
    "funnel.redirectNote": "Вы будете перенаправлены к нашему защищённому платёжному провайдеру.",
    "funnel.payOnArrivalNote": "Оплата взимается по прибытии.",
    "funnel.onlinePaymentRefNote": "Вы получите номер бронирования, который нужно указать в примечаниях к платежу для отслеживания.",
    "funnel.paymentRefTitle": "Почти готово — запишите ваш номер",
    "funnel.paymentRefInstruction": "Ваше бронирование зарезервировано. Пожалуйста, добавьте указанный ниже номер бронирования в примечания / описание платежа, чтобы мы могли сопоставить ваш платёж с этим бронированием.",
    "funnel.paymentRefNote": "Укажите этот номер в примечаниях к платежу на следующем экране.",
    "funnel.cancellationPolicy": "Политика отмены",
    "funnel.cancellationPolicyLabel": "Политика отмены:",
    "funnel.cancellationPolicyText": "Бесплатная отмена не позднее чем за 48 часов до запланированной подачи. Отмены менее чем за 48 часов до отправления не обрабатываются.",
    "funnel.policiesTitle": "Условия отмены и неявки",
    "funnel.noShowPolicy": "Политика неявки",
    "funnel.noShowPolicyText": "Если вы не находитесь в согласованном месте посадки в назначенное время и наша команда не может с вами связаться, бронирование считается неявкой и не подлежит возврату.",
    "funnel.selectedRoute": "Выбранный маршрут",
    "funnel.routeFrom": "Откуда",
    "funnel.routeTo": "Куда",
    "funnel.routeWhen": "Подача",
    "funnel.routeReturn": "Обратно",
    "funnel.routePassengers": "Пассажиры",
    // Navigation
    "nav.home": "Главная",
    ...
    "booking.outboundTrip": "Туда",
    "booking.returnTrip": "Обратно",
    ...
    "booking.aiMode": "ИИ-режим",
    "booking.aiIntro": "Здравствуйте, я ИИ-ассистент Transfera 👋 Я помогу вам забронировать трансфер шаг за шагом — вплоть до страницы с личными данными. Просто опишите поездку своими словами, например: «Из аэропорта Хургады в Steigenberger Al Dau завтра в 15:00, 4 человека».",
    "booking.aiPlaceholder": "Опишите ваш трансфер…",
    "booking.aiSend": "Отправить",
    "booking.aiThinking": "Думаю…",
    "booking.aiError": "Извините, что-то пошло не так. Повторите попытку или воспользуйтесь обычным поиском.",
    "booking.aiDisclaimer": "Помогает только с бронированием трансферов Transfera.",
    "booking.aiTitle": "ИИ-ассистент Transfera",
    "booking.aiSubtitle": "Бронирует трансфер вплоть до страницы с личными данными",
    "booking.aiMic": "Говорить",
    "booking.aiListening": "Слушаю…",
    "booking.aiVoiceOn": "Голосовые ответы включены",
    "booking.aiVoiceOff": "Голосовые ответы выключены",
    ...
    "track.emailPlaceholder": "Email, использованный при бронировании",
    "track.emailHint": "Введите номер бронирования и адрес электронной почты, который вы использовали при бронировании.",
    ...
    "blog.heading": "Блог Transfera",
    "blog.subheading": "Советы путешественникам, гиды по направлениям и всё необходимое для удобного трансфера из аэропорта в Египте.",
    "blog.read": "Читать",
    "blog.empty": "Статей пока нет. Загляните позже.",
    "blog.backToBlog": "Назад к блогу",
    "destinations.heading": "Направления трансферов из аэропортов Египта",
    "destinations.subheading": "Частные трансферы в и из всех крупных аэропортов Египта. Фиксированная цена, отслеживание рейсов, бесплатная отмена.",
    "destinations.empty": "Направления скоро появятся.",
    // Airport Coverage & FAQ sections
...
// Hook-free lookup for Server Components. Same locale → English → key
// fallback chain as useWT(). Optionally interpolates {placeholders}.
export function translate(
  ...
  let value = dict && key in dict ? dict[key] : en && key in en ? en[key] : key;
  if (vars) {
