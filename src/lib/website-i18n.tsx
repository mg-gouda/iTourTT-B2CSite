...
const translations: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    "booking.destinationCity": "Destination City",
    "booking.selectOrigin": "Select origin",
    "booking.selectDestination": "Select destination",
    "booking.returnDate": "Return date",
    "booking.returnTime": "Return time",
    "booking.orPickOnMap": "Or pin the exact spot on the map",
    "booking.searchPlace": "Search a place, hotel or address…",
    "booking.locating": "Locating…",
    "booking.placeOutside": "That spot isn't in our coverage yet — please pick a zone above.",
    "booking.placeSet": "Location set:",
    "booking.placeError": "Couldn't resolve that place. Please pick a zone above.",
  ...
  ar: {
    ...
    "booking.destinationCity": "مدينة الوصول",
    "booking.selectOrigin": "اختر نقطة الانطلاق",
    "booking.selectDestination": "اختر الوجهة",
    "booking.returnDate": "تاريخ العودة",
    "booking.returnTime": "وقت العودة",
    "booking.orPickOnMap": "أو حدد الموقع بدقة على الخريطة",
    "booking.searchPlace": "ابحث عن مكان أو فندق أو عنوان…",
    "booking.locating": "جارٍ تحديد الموقع…",
    "booking.placeOutside": "هذا الموقع خارج نطاق تغطيتنا حالياً — يرجى اختيار منطقة بالأعلى.",
    "booking.placeSet": "تم تحديد الموقع:",
    "booking.placeError": "تعذّر تحديد هذا المكان. يرجى اختيار منطقة بالأعلى.",
  ...
  de: {
    ...
    "booking.destinationCity": "Zielstadt",
    "booking.selectOrigin": "Start wählen",
    "booking.selectDestination": "Ziel wählen",
    "booking.returnDate": "Rückreisedatum",
    "booking.returnTime": "Rückreisezeit",
    "booking.orPickOnMap": "Oder den genauen Punkt auf der Karte markieren",
    "booking.searchPlace": "Ort, Hotel oder Adresse suchen…",
    "booking.locating": "Wird ermittelt…",
    "booking.placeOutside": "Dieser Punkt liegt außerhalb unseres Gebiets — bitte oben eine Zone wählen.",
    "booking.placeSet": "Standort gesetzt:",
    "booking.placeError": "Ort konnte nicht zugeordnet werden. Bitte oben eine Zone wählen.",
  ...
  fr: {
    ...
    "booking.destinationCity": "Ville d'arrivée",
    "booking.selectOrigin": "Choisir le départ",
    "booking.selectDestination": "Choisir la destination",
    "booking.returnDate": "Date de retour",
    "booking.returnTime": "Heure de retour",
    "booking.orPickOnMap": "Ou indiquez le point exact sur la carte",
    "booking.searchPlace": "Rechercher un lieu, un hôtel ou une adresse…",
    "booking.locating": "Localisation…",
    "booking.placeOutside": "Ce point n'est pas encore couvert — veuillez choisir une zone ci-dessus.",
    "booking.placeSet": "Emplacement défini :",
    "booking.placeError": "Impossible de localiser ce lieu. Veuillez choisir une zone ci-dessus.",
  ...
  it: {
    ...
    "booking.destinationCity": "Città di arrivo",
    "booking.selectOrigin": "Seleziona la partenza",
    "booking.selectDestination": "Seleziona la destinazione",
    "booking.returnDate": "Data di ritorno",
    "booking.returnTime": "Ora di ritorno",
    "booking.orPickOnMap": "Oppure indica il punto esatto sulla mappa",
    "booking.searchPlace": "Cerca un luogo, un hotel o un indirizzo…",
    "booking.locating": "Localizzazione…",
    "booking.placeOutside": "Questo punto non è ancora coperto — seleziona una zona qui sopra.",
    "booking.placeSet": "Posizione impostata:",
    "booking.placeError": "Impossibile individuare il luogo. Seleziona una zona qui sopra.",
  ...
  nl: {
    ...
    "booking.destinationCity": "Bestemmingsstad",
    "booking.selectOrigin": "Kies vertrek",
    "booking.selectDestination": "Kies bestemming",
    "booking.returnDate": "Retourdatum",
    "booking.returnTime": "Retourtijd",
    "booking.orPickOnMap": "Of markeer de exacte plek op de kaart",
    "booking.searchPlace": "Zoek een plaats, hotel of adres…",
    "booking.locating": "Locatie bepalen…",
    "booking.placeOutside": "Deze plek valt nog buiten ons gebied — kies hierboven een zone.",
    "booking.placeSet": "Locatie ingesteld:",
    "booking.placeError": "Kon die plek niet bepalen. Kies hierboven een zone.",
  ...
  ru: {
    ...
    "booking.destinationCity": "Город назначения",
    "booking.selectOrigin": "Выберите отправление",
    "booking.selectDestination": "Выберите назначение",
    "booking.returnDate": "Дата возврата",
    "booking.returnTime": "Время возврата",
    "booking.orPickOnMap": "Или укажите точное место на карте",
    "booking.searchPlace": "Найдите место, отель или адрес…",
    "booking.locating": "Определение…",
    "booking.placeOutside": "Это место пока вне зоны обслуживания — выберите зону выше.",
    "booking.placeSet": "Местоположение задано:",
    "booking.placeError": "Не удалось определить место. Выберите зону выше.",
